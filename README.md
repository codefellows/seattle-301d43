...
- Week 3: Working with the same partner each day, writing and deploying a book app. This is an exercise in creating full-stack applications which can be added as a personal portfolio item for future employers.
...
***The focus of this week is the controller layer of an MVC application.  Through the use of EJS, students will be introduced to server-side templating, deployments and development environments, managing application state, and general OOP based modularity & refactoring.***

##### Week 3 (Controller) Learning Objectives

* Students will finalize their MVC apps by:

    * completing our full-stack application with routing and controllers
...
- Course quizzes (two per week, published on Tuesdays and Fridays) are administered through Canvas.
